...
const multipage  =
{
	...
	text: `
	Dynamic Menu: The website’s navigation menu is rendered using JavaScript’s map function, pulling data from a set of objects. This allows for easy updates and scalability, ensuring the menu is always up-to-date and adaptable.
	React-Driven State Management: We utilize useState to manage user interactions and ensure a seamless and responsive experience. Whether you’re navigating between pages or interacting with elements, the UI stays fast and reactive.
